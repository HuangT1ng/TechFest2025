...
const Footer = () => {
  return (
    <>
      {/* Decorative Border */}
      <div className="h-1 bg-gradient-to-r from-indigo-300 via-purple-300 to-indigo-300 shadow-sm"></div>
      
      <footer className="bg-gradient-to-r from-indigo-50 to-purple-50 text-gray-700 py-12 mt-0">
